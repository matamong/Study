...
<article>
	<h2>Join</h2>
	<form  id="join" action="bookShop?command=join" method="post" name="formm">
	<fieldset>
		<legend>Basic Info</legend>
		<label>User ID</label> 
		<input  type="text" name="id" size="12">
		<input  type="hidden" name="reid">
		<input  type="button" value="Check ID" class="dup" onclick="idcheck()"><br>
	...
	<fieldset>
		...
		<input  type="button" value="Search Addr" class="dup" onclick="post_zip()"><br>
		<label>Address</label>
